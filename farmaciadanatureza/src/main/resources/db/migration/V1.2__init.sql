...
CREATE TABLE CAPSULA(
    ...
    PES_MAX_CAP DECIMAL(19,2) DEFAULT 0,
    PES_MIN_CAP DECIMAL(19,2) DEFAULT 0,
...
CREATE TABLE HOMEOPATIA_DOSAGEM (
    ...
    DUR_LOT_HOM_DOS BIGINT(20) DEFAULT NULL,
    ID_HOM BIGINT(20) NOT NULL,
    DIL_HOM_DOS INT(11) NOT NULL DEFAULT 0,
    TIP_DIL_HOM_DOS ENUM('CH','DH') DEFAULT 'CH',
...
CREATE TABLE HOMEOPATIA_DOSAGEM_USO_ESTOQUE(
    ID_HOM_DOS_USO_EST BIGINT(20) NOT NULL AUTO_INCREMENT,
    DAT_CRI_HOM_DOS_USO_EST DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    VER_HOM_DOS_USO_EST INT(11) NOT NULL DEFAULT 1,
    VAL_HOM_DOS_USO_EST DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    QTD_HOM_DOS_USO_EST DECIMAL(19,2) DEFAULT 0,
    POS_HOM_DOS_USO_EST VARCHAR(255),
    ID_HOM_DOS_EST BIGINT(20) NOT NULL,
    CONSTRAINT PK_HOMEOPATIA_DOSAGEM_USO_ESTOQUE PRIMARY KEY
    HOMEOPATIA_DOSAGEM_USO_ESTOQUE(ID_HOM_DOS_USO_EST),
    CONSTRAINT FK_HOMEOPATIA_DOSAGEM_USO_ESTOQUE_HOMEOPATIA_DOSAGEM_ESTOQUE
    FOREIGN KEY (ID_HOM_DOS_EST) REFERENCES HOMEOPATIA_DOSAGEM_ESTOQUE(ID_HOM_DOS_EST)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
-- POMADA --
CREATE TABLE POMADA(
...
CREATE TABLE POMADA_ESTOQUE_INTERNO(
    ID_POM_EST_INT BIGINT(20) NOT NULL AUTO_INCREMENT,
    DAT_CRI_POM_EST_INT DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    VER_POM_EST_INT INT(11) NOT NULL DEFAULT 1,
    QTD_POM_EST_INT DECIMAL(19,2) DEFAULT 0,
    ID_POM BIGINT(20) NOT NULL,
    CONSTRAINT PK_POMADA_ESTOQUE_INTERNO PRIMARY KEY POMADA_ESTOQUE_INTERNO(ID_POM_EST_INT),
    CONSTRAINT FK_POMADA_ESTOQUE_INTERNO_POMADA FOREIGN KEY (ID_POM) REFERENCES POMADA(ID_POM)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE RECEITA_HOMEOPATIA(
    ID_REC BIGINT(20) NOT NULL,
    ID_HOM_DOS_USO_EST BIGINT(20) NOT NULL,
    CONSTRAINT PK_RECEITA_HOMEOPATIA PRIMARY KEY RECEITA_HOMEOPATIA(ID_REC, ID_HOM_DOS_USO_EST),
    CONSTRAINT FK_RECEITA_HOMEOPATIA_RECEITA FOREIGN KEY (ID_REC) REFERENCES
    RECEITA(ID_REC),
    CONSTRAINT FK_RECEITA_HOMEOPATIA_HOMEOPATIA FOREIGN KEY (ID_HOM_DOS_USO_EST) REFERENCES
    HOMEOPATIA_DOSAGEM_USO_ESTOQUE(ID_HOM_DOS_USO_EST)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
